...
public:
  ...
  void update_corals();
  void update_coral_effector_inferior_lrepro(Corail &coral,
...
private:
  ...
  std::vector<Algue> tab_algue;
  std::vector<std::unique_ptr<Corail>> tab_corail;
  std::vector<Scavenger> tab_scavenger;
};
